const languages = {
    ...
    "clerk": ["Clerk", "收銀員"],
    "product_sync_tips": ["Set to 0 will sync all products. Otherwise it will only sync products that create/update within specific day", "設定為 0 將同步所有產品。 否則，它只會同步在特定日期內建立/更新的產品"],
