...
import {Form, Overlay, OverlayTrigger, ProgressBar, Tooltip} from "react-bootstrap";
        ...
        <>
            <div className={"border-opacity-25 p-4 border-dark border"}>
                ...
                <div className={"d-flex flex-row align-items-center"}>
                    <Form.Group className={"w-50 d-flex flex-row mb-3 align-items-center"}>
                        <Form.Label className={"mb-0 w-25"}>Max day:</Form.Label>
                    ...
                    <div className={"mb-3 ms-2"}>
                        {syncObj.playing ?
                            <Button onClick={pauseSyncProduct}>Pause</Button> :
                            syncObj.page > 1 ?
                                <Button onClick={resumeSyncProduct}>Resume</Button>
                                :
                                <Button onClick={startSyncProduct}>Sync</Button>
                        }
